...
<body>
    ...
    <div class="nav-left">
        ...
        <a href="/StudentLearning">Learn</a>
    ...
    <div class="container">
        ...
        <section class="welcome-section">
            ...
            <a href="/StudentLearning" class="btn-continue">
            ...
            <div class="column">
                ...
                <div>
                    ...
                    <div class="card">
                        ...
                        <a href="/StudentCommunity" class="link-view">View Topic <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                </div>
