...
<body>
    ...
    <main class="dashboard-container">
        <section id="suppliers" class="page-content active-page">
            ...
            <p class="page-subtitle">Manage all suppliers in the EnerSave platform.</p>

            <div class="data-management-panel">
                <div class="filter-bar">
                    <div class="search-box">
                        <i class="fas fa-search"></i>
                        <input type="text" id="searchInput" placeholder="Enter supplier name, email, or ID">
                    </div>
            ...
            <div class="details-panel">
                ...
                <div class="details-actions">
                    <button class="btn btn-success" id="updateRoleBtn">Update Role</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <label for="editFullName">Supplier Name</label>
    ...
    <script>
        ...
        function saveEdit() {
            ...
            if (currentEditRow.classList.contains('selected')) {
                updateSupplierDetailsPanel(currentEditRow);
            }
        ...
        banBtns.forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                confirmModalTitle.textContent = 'Ban Supplier';
                confirmMessage.textContent = `Are you sure you want to ban "${supplierName}"? This action will restrict their access to the platform.`;
                confirmBtn.textContent = 'Ban Supplier';
        ...
        unbanBtns.forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                const supplierName = row.getAttribute('data-name');
                confirmModalTitle.textContent = 'Unban Supplier';
                confirmMessage.textContent = `Are you sure you want to unban "${supplierName}"? This will restore their access to the platform.`;
                confirmBtn.textContent = 'Unban Supplier';
        ...
        function confirmAction() {
            ...
            if (currentAction === 'ban') {
                ...
                alert('Supplier has been banned successfully.');
                ...
                alert('Supplier has been unbanned successfully.');
            }
            
            // Update detail panel if this row is selected
            if (currentActionRow.classList.contains('selected')) {
                updateSupplierDetailsPanel(currentActionRow);
            }
            
            closeConfirmModal();
        }

        // Update Supplier Details Panel when clicking on a table row
        function updateSupplierDetailsPanel(row) {
            const name = row.getAttribute('data-name') || '-';
        ...
        Array.from(tableRows).forEach(row => {
            ...
            row.addEventListener('click', function(e) {
                ...
                updateSupplierDetailsPanel(this);
