<?php
$pageTitle = 'Add Learning Resource';
...
<body>
    ...
    <div class="form-container">
        <div class="form-card">
            <h1 class="form-title">Add Learning Resource</h1>
            <p class="form-subtitle">Create a new learning resource for the community</p>

            <form method="POST" action="/learn/add-resource" enctype="multipart/form-data">
                <!-- Title Field -->
