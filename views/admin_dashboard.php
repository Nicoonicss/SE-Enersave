            ...
            <div class="dashboard-grid">
                ...
                <div class="quick-actions-panel">
                    ...
                    <div class="action-buttons">
                        <button onclick="window.location.href='/admin/users'"><i class="fas fa-users"></i> Manage Users</button>
                        <button onclick="window.location.href='/admin/suppliers'"><i class="fas fa-bolt"></i> Manage Suppliers</button>
                        <button onclick="window.location.href='/admin/projects'"><i class="fas fa-sun"></i> Manage Projects</button>
                    </div>
                </div>
