document.addEventListener('DOMContentLoaded', () => {
    ...
    // Define the routes for Student pages
    const pages = {
        'Home': '/StudentDashBoard',
        'Learn': '/StudentLearning',
        'Community': '/StudentCommunity',
        'EnerSave': '/StudentDashBoard' // Clicking Brand Name goes to Dashboard
    };
    ...
    if (btnContinue) {
        btnContinue.addEventListener('click', (e) => {
            e.preventDefault();
            window.location.href = '/StudentLearning';
        });
    }
    ...
    if (linkViewTopic) {
        linkViewTopic.addEventListener('click', (e) => {
            e.preventDefault();
            window.location.href = '/StudentCommunity';
        });
    }
    ...
    // Discussion Buttons (Reply, View Thread)
